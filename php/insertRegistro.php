        ...
        <nav class="navbar navbar-inverse navbar-static-top navbar-fixed-top top-nav-collapse">
          <div class="container">
            <div class="navbar-header">
              ...
              <img class="img-responsive visible-xs visible-ms hidden-lg" src="../images/logo-sm.png"/></a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="../index.html">Ecuador</a></li>
                <li><a href="../equilibrio.html">&nbsp; &nbsp; Tips &nbsp; &nbsp;</a></li>
              ...
              <div class="row">
                <div class="col-md-6 space-right-20">
                    <section class="login element-emphasis-strong">
                        ...
                        <form role="form" action="php/insertUsuario.php" method="post" novalidate>
							...
							<?php
								...
								include_once("RegistroCollector.php"); 
								$RegistroCollectorObj = new RegistroCollector();
								$RegistroCollectorObj->createRegistro($nombre,$apellido,$correo,$contrasena);
								?>                        
								<label class="texto-info" for="email ">	
								Bienvenidos a nuestra comunidad Ecuador en un Click.</label>      							
      ...
      <footer>
          <div class="container">
              ...
              <!-- **********************8 -->
                ...
                <div class="col-lg-4 hidden-xs hidden-sm hidden-m foot">
                    <div class="col-lg-6 imgfoot"><center><a href="#"><img class="img-responsive" src="../images/f1.png"/></a></center></div>
